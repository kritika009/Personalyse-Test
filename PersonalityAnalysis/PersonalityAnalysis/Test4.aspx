    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li  class="nav-item">
        ...
        <div class="starter-template">
            <strong>You prefer to think first, then speak.   
        ...
        <div class="starter-template">
            <strong>You focus on what is possible (in the future).   
        ...
        <div class="starter-template">
            <strong>You mostly take actions by heart.   
        ...
        <div class="starter-template">
            <strong>You are organized and structured.   
        ...
        <div class="starter-template">
            <strong>Your travel plans are usually made in advance.   
        ...
        <asp:Button ID="Button1" runat="server" Text="Results"  ShowRoundedCorner="true" OnClick="Button1_Click" BackColor="#CC3300" BorderStyle="Solid" ForeColor="White" Height="45px" Width="95px"/>
    </div>
